        ...
        def __init__(
            ...
            with FileLock(lock_path):
                ...
                if os.path.exists(cached_features_file) and not overwrite_cache:
                    ...
                    examples = (
                        processor.get_dev_examples(data_dir, eval_data_name) if evaluate
                        else processor.get_train_examples(data_dir, train_data_name)
                    )
...
class HansProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir, data_name):
        """See base class."""
        return self._create_examples(self._read_tsv(os.path.join(data_dir, data_name)), "train")

    def get_dev_examples(self, data_dir, data_name):
        """See base class."""
        return self._create_examples(self._read_tsv(os.path.join(data_dir, data_name)), "dev")
